package com.jhfuture.jhojbackendquestionservice.service.impl;
...
import com.jhfuture.jhojbackendcommon.constant.CommonConstant;
...
import com.jhfuture.jhojbackendcommon.utils.SqlUtils;
...
import com.jh.jhojbackendmodel.model.enums.QuestionSubmitLanguageEnum;
...
import com.jhfuture.jhojbackendquestionservice.mapper.QuestionSubmitMapper;
...
//    /*
//    注意：问题服务这里使用到了 userservice ，而 其是用户服务中的一个模块，这里通过引入 service-client 进行调用
//
//    */
    @Resource
...
//        });
            //通过消息队列
        rabbitMqMessageProducer.sendMessage("code_exchange", "awaitJudge", String.valueOf(questionSubmitId));
